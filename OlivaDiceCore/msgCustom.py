...
dictStrCustom = {
    ...
    'strRollError01' : '掷骰错误！无法解析的表达式！',
    'strRollError02' : '掷骰错误！无法计算的表达式！',
    'strRollError03' : '掷骰错误！输入了非法的表达式！',
    'strRollError04' : '掷骰错误！输入了非法的子参数！',
    'strRollError05' : '掷骰错误！输入了非法的运算符！',
    'strRollError06' : '掷骰错误！发现未定义运算符！',
    'strRollError07' : '掷骰错误！解析到空语法树！',
    'strRollError08' : '掷骰错误！错误的左值！',
