...
dictPcCardTemplateDefault = {
    ...
    'DND5E': {
        ...
        'synonyms':{
            ...
            'WIS': ['感知', 'WIS','Wisdom'],
            'CHA': ['魅力', 'CHA','Charisma'],
            'Athletics':['运动','Athletics'],
            'ABI-DALZIM_S_HORRID_WILTING':['亚比达奇凋死术','ABI-DALZIM_S_HORRID_WILTING'],
            'ABSORB_ELEMENTS':['吸收元素','ABSORB_ELEMENTS'],
            'ACID_ARROW':['强酸箭','ACID_ARROW'],
            'ACID_SPLASH':['酸液飞溅','ACID_SPLASH'],
            'AGANAZZAR_S_SCORCHER':['阿迦纳萨喷火术','AGANAZZAR_S_SCORCHER'],
            'AID':['援助术','AID'],
            'ALARM':['警报术','ALARM'],
            ...
            "ARCANIST_S_MAGIC_AURA":['秘法师魔法灵光','ARCANIST_S_MAGIC_AURA'],
            ...
            'AWAKEN':['启蒙术','AWAKEN'],
            'Carring_Capacity':['载重','Carring_Capacity'],
            'Encumbrance':['负重','Encumbrance'],
            'Acrobatics':['体操','Acrobatics'],
            'Sleight_of_Hand':['Sleight_of_Hand','巧手','手上功夫'],
            'Stealth':['Stealth','隐匿'],
            'Arcana':['Arcana','奥秘'],
            'History':['History','历史'],
            ...
            'Animal_Handling':['Animal_Handling','动物驯养','驯兽'],
            'Insight':['Insight','洞悉'],
            'Medicine':['Medicine','医药'],
            'Perception':['Perception','察觉','观察'],
            'Survival':['Survival','生存','求生'],
            'Deception':['Deception','欺瞒'],
            'Intimidation':['Intimidation','威吓'],
            'Performance':['Performance','表演'],
            'Persuasion':['Persuasion','游说'],
            'Armor_Class':['AC','Armor_Class','护甲等级'],
            'Gold_Piece':['Gold_Piece','金币','GP'],
            'Silver_Piece':['Silver_Piece','银币','SP'],
            'Copper_Piece':['Copper_Piece','CP','铜币'],
            'Electrum_Piece':['Electrum_Piece','铂金币','EP'],
            'Platium_Piece':['Platium_Piece','白金币','PP'],
        },
        'showName': {
            'STR': '力量',
            'DEX': '敏捷',
